...
export type SelectorKind = 
  | typeof SELECTOR_LOADER
  | typeof SELECTOR_OPERATOR;
...
const QuerySelector = ({kind, onClose}: QuerySelector): JSX.Element => {
  switch (kind) {
    case SELECTOR_LOADER: return <LoaderSelector onClose={onClose} />;
    case SELECTOR_OPERATOR: return <OperationSelector onClose={onClose} />
  }
};
